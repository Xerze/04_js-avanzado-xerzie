...
const server = http.createServer((request, response) => {
    ...
    response.write('<html><body>Cambio con Nodemon en vivo. Tengo que refrescar... pero no tuve que terminar mi terminal. Esto está escrito en el tercer intento :P </body></html>');
    response.end();
